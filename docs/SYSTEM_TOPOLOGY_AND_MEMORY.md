...
1. מקורות סטטוס: `STATUS.md` הוא מקור סטטוס הפרויקטים ו-`PROJECT_INDEX.md` הוא אינדקס הפרויקטים בשורש המאגר. מסמך טופולוגיה זה מתאר את המערכת ואינו מחליף את שניהם. אם יש סתירה, יש לבדוק את המקורות לפני שינוי סטטוס.
